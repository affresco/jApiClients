...
import jClient.base.BaseClient;
import jClient.base.Message;
import jClient.delta.factories.AuthenticationMessage;
import jClient.delta.factories.SupportingMessage;
...
public class DeltaClientCore extends BaseClient {
    ...
    public DeltaClientCore(String url, DeltaCredentials credentials, String clientId) throws URISyntaxException {
        this(url, credentials, clientId, true);
    }

    public DeltaClientCore(String url, DeltaCredentials credentials, String clientId, boolean blockOnConnection) throws URISyntaxException {
