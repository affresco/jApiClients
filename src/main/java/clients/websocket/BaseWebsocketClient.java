...
public abstract class BaseWebsocketClient extends WebSocketClient  {
    ...
    public BaseWebsocketClient(URI serverURI, Credentials credentials) {
        super(serverURI);
        this.credentials = credentials;
    }

    public BaseWebsocketClient(String url, Credentials credentials) throws URISyntaxException {
        super(new URI(url));
        this.credentials = credentials;
    }
